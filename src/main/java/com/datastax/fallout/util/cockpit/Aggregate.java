...
public record Aggregate<T> (
    ...
    String name,
    T value,
    @Nullable @JsonInclude(JsonInclude.Include.NON_NULL) String node,
    @Nullable @JsonInclude(JsonInclude.Include.NON_NULL) String phase) {
    ...
    public static <T> Aggregate<T> of(String component, String category, String name, T value, String node,
        String phase)
    {
        return new Aggregate<T>(component, category, name, value, node, phase);
    }

    public Aggregate<T> withPhase(String phase)
    {
        return Aggregate.of(component(), category(), name(), value(), node(), phase);
    }
}

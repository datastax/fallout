...
public class FalloutConfiguration extends Configuration
{
    ...
    /**
     * Absolute path to a local directory (to be created) where we will store creds generated by Fallout users, When present,
     * and awsKMSKeyId is not, runs Fallout with
     * {@link com.datastax.fallout.service.core.CredentialStore.LocalCredentialStore}.
     */
    @JsonProperty
    private String localCredentialStoreDirectory;
    ...
    public String getLocalCredentialStoreDirectory()
    {
        return localCredentialStoreDirectory;
    }

    public void setLocalCredentialStoreDirectory(String localCredentialStoreDirectory)
    {
        this.localCredentialStoreDirectory = localCredentialStoreDirectory;
    }

...
public class FakeConfigurationManager extends ConfigurationManager
{
    private static String name = "fake";
    private static String prefix = "test.configuration.management." + name + ".";
